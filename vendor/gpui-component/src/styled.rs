...
pub trait StyledExt: Styled + Sized {
    ...
    fn popover_style(self, cx: &App) -> Self {
        self.bg(cx.theme().popover)
            ...
            // Scirè patch: shadow removed — shadow_lg cast a heavy halo when a popup
            // menu opened over the bright album grid. Flat menus, border-only.
            // Applies to all popovers/menus/dropdowns app-wide.
